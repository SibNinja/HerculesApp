...
public class BDHelper extends SQLiteOpenHelper {
    ...
    static final String TABLE = "stand";
    private static final int DB_VERSION = 1;


    public static final String COLUMN_ID="_id";
    public static final String COLUMN_WH = "wh";
    ...
    public static final String COLUMN_BASIN = "basin";
    public static final String COLUMN_HIPS = "hips";
    public static final String COLUMN_SHIN = "shin";
